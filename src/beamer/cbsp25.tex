...
\title[Accessibility in Resident Evil 4]{Enhancing Accessibility Options in Resident Evil 4 using Object Detection}
...
\begin{frame}
  ...
  \begin{center}\qrcode{https://github.com/grayespinoza/cbsp25}
  \end{center}
\end{frame}
